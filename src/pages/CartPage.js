...
const stripePromise = loadStripe("pk_test_51NApbICtLZf8KBneCUpwyW85K6QILDMXakCTNYH4pL0U4YGQ64C4uwwDm0zO0mXsgvrhCA9JfQp498wtMfNxwRyB00oMc8bDnQ");
                  ...
                  {cart.map((item) => (
                    <tr>
                      ...
                      <td>
                        ...
                        <img src={item.pictures[0].url} style={{ width: 100, height: 100, objectFit: "cover" }} alt="product-img" />
                      </td>
                      <td>${item.price}</td>
                      <td>
